            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Credit to{" "}
                        <span className="font-bold tracking-tight bg-gradient-to-r from-blue-400 to-sky-500 bg-clip-text text-transparent  underline">
                            <a href="http://instagram.com/code_wars_official">
                                @code_wars_official
                            </a>
                        </span>{" "}
                        on Instagram
            ...
            {filteredProjects.length === 0 ? (
                <Card className="py-12 border-pink-400/20">
                    <CardContent className="flex flex-col items-center justify-center text-center">
                        ...
                        <CardDescription>
                            Try adjusting your search query or browse all
                            projects
                        </CardDescription>
                        {searchQuery && (
                            <Button
