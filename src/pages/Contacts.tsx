...
export default function Contacts() {
  return (
    <div className="space-y-8 max-w-2xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-[#A78BFA] via-[#C4B5FD] to-[#A78BFA] bg-clip-text text-transparent">
          Get in Touch
        </h1>
      ...
      <Card className="bg-gradient-to-br from-[#A78BFA]/10 via-[#C4B5FD]/10 to-[#A78BFA]/10 border-[#A78BFA]/20 overflow-hidden relative">
