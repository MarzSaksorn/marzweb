...
const currentProjectImage = "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=400&fit=crop"
      ...
      <Card className="border-l-4 border-l-pink-400 overflow-hidden relative">
        ...
        <CardHeader className="relative">
          ...
          <CardDescription className="text-base">
            A personal showcase of my journey in software development, featuring my latest projects, 
            skills, and ways to connect. Built with performance and accessibility in mind.
          </CardDescription>
        </CardHeader>
        <CardContent className="relative">
          <p className="text-muted-foreground leading-relaxed">
            This website serves as a central hub for exploring my work, from web applications 
            to creative experiments. Each project reflects my commitment to clean code, 
            intuitive design, and meaningful functionality. Feel free to browse through 
      ...
      <div>
        ...
        <Card className="overflow-hidden group hover:shadow-xl hover:shadow-pink-400/10 transition-all duration-300 border-pink-400/20">
          ...
          <CardFooter className="gap-2">
            <Button variant="outline" className="border-pink-400/50 hover:bg-pink-400/10" asChild>
